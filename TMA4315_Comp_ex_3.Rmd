...
We now want our model to predict a probability in the range $[0, 1]$. It is no longer suitable to use a linear mixed effects model because our random effects are bounded and assuming normality of them is no longer reasonable.
