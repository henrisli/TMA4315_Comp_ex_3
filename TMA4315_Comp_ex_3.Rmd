...
To create a reasonable model we must instead consider some transformation $g(\cdot): [0, 1] \rightarrow (-\infty, \infty)$, called the link function. In this case, it will be suitable to consider a generalized linear mixed model with a binomial response. We then assume
