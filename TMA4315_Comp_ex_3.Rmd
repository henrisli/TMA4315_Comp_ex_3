...
We see that the parameters `gender` and `raven` (and the intercept) are approximately the same for the two models. Because we have fairly balanced data (almost same amount of students in every school), the parameters will be almost the same when all students have the same intercept vs. when every school has its own intercept.
...
And this gives
$$\beta_{\text{female}} \in [2.51119 - 1.96\cdot0.26684, 2.51119 + 1.96\cdot0.26684].$$
